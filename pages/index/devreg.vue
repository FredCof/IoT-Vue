<template>
	<view class="uni-common-mt">
		...
		<view class="uni-form-item uni-column">
			<view class="with-fun">
				<input class="uni-input inputText" placeholder="输入设备名称" type="text" :value="devname" maxlength="15" @input="nameInput"/>
			</view>
		</view>
		<view class="line"></view>
		<view class="uni-padding-wrap uni-common-mt">
			<button type="primary" :disabled="btnRenameDisable" @tap="rename">修改设备名称</button>
		</view>
	</view>
</template>
...
<script>
	export default {
		...
		methods: {
			...
			rename(){
				console.log("rename URL:"+this.globalVal.default_url.devRename);
				uni.showLoading({
					title: '修改中...',
					mask: false
				});
				...
				var errmsg = "失败";
				uni.request({
					url: this.globalVal.default_url.devRename,
					method: 'POST',
					data: {
						deviceId:this.devid,
